...
export const SCIENTIFIC_EVIDENCE: Record<string, ScientificEvidenceItem> = {
  ...
  'pr_rsm_edwards_polynomial_fit': {
    ...
    key_papers: [
      { title: 'On the use of polynomial regression equations as an alternative to difference scores in organizational research', authors: 'Jeffrey R. Edwards & Mark E. Parry', year: 1993, journal: 'Academy of Management Journal', doi: "10.5465/256643", open_access_url: null },
      { title: 'Alternatives to difference scores: Polynomial regression analysis and response surface methodology', authors: 'Jeffrey R. Edwards', year: 2002, journal: 'Measuring and Analyzing Behavior in Organizations', doi: null, open_access_url: null }
    ],
  ...
  'angular_agreement_riasec_congruence': {
    ...
    key_papers: [
      { title: 'A preliminary analysis of the psychometric properties of the German O*NET interest profiler short form in rehabilitation education', authors: 'Steffen Wild & Michélle Möhring', year: 2026, journal: 'Frontiers in Rehabilitation Sciences', doi: "10.3389/fresc.2026.1789335", open_access_url: "https://www.frontiersin.org/journals/rehabilitation-sciences/articles/10.3389/fresc.2026.1789335/pdf" }
    ],
  ...
  'meta_analysis_bigfive_riasec_correlations': {
    ...
    key_papers: [
      { title: 'Higher-order dimensions of the Big Five personality traits and the Big Six vocational interest types', authors: 'Michael K. Mount, Murray R. Barrick, Steven M. Scullen, James Rounds', year: 2005, journal: 'Personnel Psychology', doi: "10.1111/j.1744-6570.2005.00668.x", open_access_url: "http://www.sitesbysarah.com/mbwp/Pubs/2005_Mount_Barrick_Scullen_Rounds_PP.pdf" },
      { title: 'Personality and vocational interests: A meta-analysis', authors: 'M. R. Barrick, M. K. Mount, & R. Gupta', year: 2003, journal: 'Journal of Vocational Behavior', doi: "10.1016/S0001-8791(02)00026-9", open_access_url: null }
    ],
